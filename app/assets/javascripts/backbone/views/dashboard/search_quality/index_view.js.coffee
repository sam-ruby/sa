Searchad.Views.Dashboard.SearchQualityQuery ||= {}

class Searchad.Views.Dashboard.SearchQualityQuery.IndexView extends Backbone.View
  ...
  initialize: (options) =>
    ...
    @controller.bind('date_changed', @getItems)
