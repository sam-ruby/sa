$ ->
  ...
  do ->
    ...
    controller.on('all', (name) ->
      ...
      if name.match(/search-rel:index|search-kpi|do-search|poor-performing-stats:index|poor-performing:index|pp:stats:index|pp:walmart-items:index|pp:amazon-items:index|query-comparison|search:form/)
